-- Complete Database Fix for Windows Installation
-- This combines all fixes into a single file
...
-- =====================================================
-- STEP 2: Add missing columns to tokens_unified
-- =====================================================
...
-- =====================================================
-- STEP 6: Fix foreign key constraint issues
-- =====================================================
...
-- Create a trigger to automatically create tokens when trades reference new ones
...
-- Create any missing tokens for existing trades
INSERT INTO tokens_unified (
    mint_address,
    symbol,
    name,
