...
export const config = {  
  ...
  shyft: {  
    ...
    // ✅ Added missing rpcUrl field
    rpcUrl: process.env.SHYFT_RPC_URL || `https://rpc.shyft.to?api_key=${process.env.SHYFT_API_KEY}`
  },  
  ...
  // Enhanced price refresh configuration  
  priceRefresh: {  
